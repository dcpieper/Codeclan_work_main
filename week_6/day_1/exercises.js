...
const myArray = ['Salamanders', 'Emperors Children', 'Ultramarines', 'Death Guard' ];

myArray[0] = 'Night Lords';
myArray[1] = 'World Eaters';

myArray.unshift('Blood Angels');
myArray.pop();
...
const splicedPL = programmingLanguages.splice(programmingLanguages.indexOf('Visual Basic'), 1);
